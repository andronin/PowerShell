...
function SendTelegram
{
    ...
    write-host ""    
    Write-Host "Code is $CodeState" -ForegroundColor DarkYellow
    foreach ( $TG_Bot in $TG_Bots )
    {
        ...
        Write-Host -ForegroundColor Red "Bot is "$TG_Bot.BOTNAME
        $Body = @{
            chat_id = "$TG_ChatID"
    ...
    write-host ""
    Write-Host "Pushing to Telegram"
...
$TG_Bots | ft -AutoSize
SendTelegram -TelegramMessage "This is a test"
